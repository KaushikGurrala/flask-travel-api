...
# Create Database (SQLite file in same folder)
...
#https://www.nerdnook.io/
#Create Routes

@app.route("/")
def home():
    return jsonify("Welcome to TravelAPI")


#https://www.nerdnook.io/destinations
...
#https://www.nerdnook.io/destinations/2
